...
<title>Electronics - Parakrama</title>
<link rel="stylesheet"
		...
		<%-- <div class="row">
			...
			<ul class="products">
				<li class="product">
					<div class="product-under">
						<figure class="product-image">
							<img src="<spring:url value="/resources/images/Electronics/1.png" />">
							<div class="product-over">
						...
						<div class="product-summary">
							<h4 class="productName">Acer Swift 3 13.5 Full HD LED Display Intel Core i7 11th Gen 8GB RAM 512GB SSD 1</h4>
							<h6 class="price">
				...
				<li class="product">
					<div class="product-under">
						<figure class="product-image">
							<img src="<spring:url value="/resources/images/Electronics/2.jpg" />">
							<div class="product-over">
						...
						<div class="product-summary">
							<h4 class="productName">Canon EOS 90D DSLR Camera Body + 3 Lens Kit 18-55mm IS STM + 16GB + Flash 2</h4>
							<h6 class="price">
				...
				<li class="product">
					<div class="product-under">
						<figure class="product-image">
							<img src="<spring:url value="/resources/images/Electronics/3.jpg" />">
							<div class="product-over">
						...
						<div class="product-summary">
							<h4 class="productName">Epson WorkForce EC-C7000 Inkjet Multifunction Printer 2</h4>
							<h6 class="price">
				...
				<li class="product">
					<div class="product-under">
						<figure class="product-image">
							<img src="<spring:url value="/resources/images/Electronics/4.jpg" />">
							<div class="product-over">
						...
						<div class="product-summary">
							<h4 class="productName">External Stereo Microphone For DSLR Camera Canon Nikon Panasonic Sony Camcorder 1</h4>
							<h6 class="price">
				...
				<li class="product">
					<div class="product-under">
						<figure class="product-image">
							<img src="<spring:url value="/resources/images/Electronics/5.jpg" />">
							<div class="product-over">
						...
						<div class="product-summary">
							<h4 class="productName">NEW Asus Ultra Thin 15.6 FHD Intel Celeron N4020 128GB eMMC 4GB RAM Win 10 Home 2</h4>
							<h6 class="price">
				...
				<li class="product">
					<div class="product-under">
						<figure class="product-image">
							<img src="<spring:url value="/resources/images/Electronics/6.jpg" />">
							<div class="product-over">
						...
						<div class="product-summary">
							<h4 class="productName">SteelSeries 61481 Arctis 9X Wireless Gaming Headset Xbox Noise-Cancel Mic 4</h4>
							<h6 class="price">
				...
				<li class="product">
					<div class="product-under">
						<figure class="product-image">
							<img src="<spring:url value="/resources/images/Electronics/7.jpg" />">
							<div class="product-over">
						...
						<div class="product-summary">
							<h4 class="productName">Razer Kraken Pink Kitty Edition Quartz Pink RZ04_02980200 Chroma Certified 1</h4>
							<h6 class="price">
				...
				<li class="product">
					<div class="product-under">
						<figure class="product-image">
							<img src="<spring:url value="/resources/images/Electronics/8.jpg" />">
							<div class="product-over">
						...
						<div class="product-summary">
							<h4 class="productName">Nikon Z 6II Mirrorless Digital Camera Body 24.5 MP Full-Frame 1</h4>
							<h6 class="price">
				...
				<li class="product">
					<div class="product-under">
						<figure class="product-image">
							<img src="<spring:url value="/resources/images/Electronics/9.jpg" />">
							<div class="product-over">
						...
						<div class="product-summary">
							<h4 class="productName">LED Light Speaker Wireless Smart Bulb RGB 15W Music Playing Smart Remote 2021 4</h4>
							<h6 class="price">
				...
				<li class="product">
					<div class="product-under">
						<figure class="product-image">
							<img src="<spring:url value="/resources/images/Electronics/10.jpg" />">
							<div class="product-over">
						...
						<div class="product-summary">
							<h4 class="productName">LED Light Speaker Wireless Smart Bulb RGB 15W Music Playing Smart Remote 2021 3</h4>
							<h6 class="price">
								Rs <span class="priceValue">365</span> / Unit
							</h6>
						</div>
					</div>
				</li>
				<li class="product">
					<div class="product-under">
						<figure class="product-image">
							<img src="<spring:url value="/resources/images/Electronics/11.jpg" />">
							<div class="product-over">
						...
						<div class="product-summary">
							<h4 class="productName">6-Pack 75W Eq. LED Bulb 60-Chip Corn Light E26 1100lm 10W Cool Daylight 6000K 6X 1</h4>
							<h6 class="price">
								Rs <span class="priceValue">700</span> / Unit
							</h6>
						</div>
					</div>
				</li>
				<li class="product">
					<div class="product-under">
						<figure class="product-image">
							<img src="<spring:url value="/resources/images/Electronics/12.jpg" />">
							<div class="product-over">
						...
						<div class="product-summary">
							<h4 class="productName">Netac 500GB SSD 2.5'' SATA III 6 Gb_s Internal Solid State Drive 500MB_s PC_MAC 1</h4>
							<h6 class="price">
								Rs <span class="priceValue">240</span> / Unit
							</h6>
						</div>
					</div>
				</li>
				<li class="product">
					<div class="product-under">
						<figure class="product-image">
							<img src="<spring:url value="/resources/images/Electronics/13.jpg" />">
							<div class="product-over">
						...
						<div class="product-summary">
							<h4 class="productName">VIVINT Space Monkey Online Storage Device, White 1TB Wireless DVR SM1-2W10 used 1</h4>
							<h6 class="price">
				...
				<li class="product">
					<div class="product-under">
						<figure class="product-image">
							<img src="<spring:url value="/resources/images/Electronics/14.jpg" />">
							<div class="product-over">
						...
						<div class="product-summary">
							<h4 class="productName">LED Light Speaker Wireless Smart Bulb RGB 15W Music Playing Smart Remote 2021 1</h4>
							<h6 class="price">
				...
				<li class="product">
					<div class="product-under">
						<figure class="product-image">
							<img src="<spring:url value="/resources/images/Electronics/15.jpg" />">
							<div class="product-over">
						...
						<div class="product-summary">
							<h4 class="productName">Netac 500GB SSD 2.5'' SATA III 6 Gbs Internal Solid State Dri_ve 500MBs PC_MAC 3</h4>
							<h6 class="price">
								Rs <span class="priceValue">19500</span> / Unit
							</h6>
						</div>
					</div>
				</li>
				<li class="product">
					<div class="product-under">
						<figure class="product-image">
							<img src="<spring:url value="/resources/images/Electronics/16.gif" />">
							<div class="product-over">
						...
						<div class="product-summary">
							<h4 class="productName">AUXITO 7443 LED Bulb Turn Signal Backup Reverse Light Lamp T20 7440 White CANBUS 1</h4>
							<h6 class="price">
								Rs <span class="priceValue">990</span> / Unit
							</h6>
						</div>
					</div>
				</li>
