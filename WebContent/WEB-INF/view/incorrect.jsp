...
<meta charset="utf-8" />
<title>Login Error | Parakrama - Web Site</title>
						...
						<div>
							<div class="row justify-content-center">
								<div class="col-sm-4">
									<div class="error-img">
										<img
											src="<spring:url value="/resources/images/404-error.png" />"
											alt="" class="img-fluid mx-auto d-block">
									</div>
								</div>
							</div>
						</div>
						<h4 class="text-uppercase mt-4">Sorry, User login Fail!</h4>
						<p class="text-muted">It will be as simple as Error data
							entering or do not match data !</p>
						<div class="mt-5">
							<a class="btn btn-primary waves-effect waves-light" href=. />Back
							to Login</a>
						</div>
					</div>
